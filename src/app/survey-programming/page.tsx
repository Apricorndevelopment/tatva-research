...
// export default function SurveyProgramming() {
//   return (
...
//               seamless implementation aligned with research objectives.
//             </p>
...
//         {/* Highlights */}
//         <div className="mt-16 grid sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
...
//               Fast turnaround for MaxDiff, Conjoint & Segmentation studies
//             </p>
//           </div>
...
//             </h4>
//             <p className="text-sm text-body-color dark:text-body-color-dark mt-2">
//               ConfirmIT, Nebu, Decipher & proprietary tools
//             </p>
//           </div>
...
//             </h4>
//             <p className="text-sm text-body-color dark:text-body-color-dark mt-2">
//               Logic-tested surveys with clean, analysis-ready data
//             </p>
//           </div>
...
//             </h4>
//             <p className="text-sm text-body-color dark:text-body-color-dark mt-2">
//               Tailored programming for unique research needs
//             </p>
//           </div>
//         </div>
